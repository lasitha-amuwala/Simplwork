		...
		<ProtectedPage>
			<div className='bg-white rounded-3xl border mt-7 w-full overflow-hidden'>
				<div className='relative'>
					...
					<div className='absolute top-1/2 -translate-y-1/3 left-10 rounded-full w-[175px] h-[175px] bg-sky-200 overflow-hidden flex justify-center items-center shadow-lg '>
