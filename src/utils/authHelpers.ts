...
import { CandaidateProfile, CandidateLocation } from '../types/api/candidate';

export const createCandidateRequestBody = (values: FormikValues, location: CandidateLocation, email: string) => {
