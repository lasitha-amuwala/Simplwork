...
type Props = {
	...
	backgroundShifts: SW.IShift[];
};

export const AvailabilityExpand = ({ availability, backgroundShifts }: Props) => {
	const [open, setOpen] = useState(false);

	return (
		<div className='flex flex-col gap-5'>
			<div className='pr-1'>{renderWidget({ readonly: true, events: availability, backgroundEvents: backgroundShifts })}</div>
