		...
		return (
			<DialogPrimitive.Portal>
				...
				<DialogPrimitive.Content
					...
					ref={forwardedRef}
					className={twMerge(
						'z-[100] data-[state=open]:animate-contentShow overflow-auto fixed top-[50%] left-[50%] max-h-[85vh] w-[95%] translate-x-[-50%] translate-y-[-50%] rounded-[6px] bg-white p-[30px] shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none',
						className
					)}>
					{children}
